...
// this function checks for a delimiter (a piece of data
// that separates it from others) to perform specific cases
...
// this function checks for an operator
...
// this function parses the input and counts tokens
